                ...
                <div className="divide-y divide-slate-100">
                  {jobs.map(j => (
                    <div key={j.id}>
                      ...
                      {expanded === j.id && (
                        <div className="px-5 pb-4 pt-1 bg-slate-50/60 text-sm text-slate-600 space-y-1.5 animate-fade-in">
                          ...
                          <div className="px-5 pb-4 pt-1 bg-slate-50/60 animate-fade-in">
                            ...
                            {pending ? (
                              <div className="flex items-center justify-between gap-3 flex-wrap">
                                <p className="text-xs text-slate-500">Total <span className="font-bold text-slate-800">{money(q.total)}</span> — respond below:</p>
                              ...
                              <p className={`text-sm font-medium ${q.status === 'accepted' ? 'text-emerald-600' : 'text-slate-500'}`}>
                                You {q.status} this estimate.
                              </p>
                            )}
                          </div>
                        )}
